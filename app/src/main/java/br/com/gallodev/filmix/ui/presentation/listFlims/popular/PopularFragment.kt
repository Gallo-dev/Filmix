package br.com.gallodev.filmix.ui.presentation.listFlims.popular
...
class PopularFragment : Fragment() {
    ...
    companion object {
        private const val ARG_FILMS_POPULAR = "films"

        // Método estático para criar uma instância do fragmento
        fun newInstance(films: List<Film>): PopularFragment {
            val fragment = PopularFragment()
            val args = Bundle()
            args.putParcelableArrayList(ARG_FILMS_POPULAR, ArrayList(films))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.buscaFilmePorCategoria(Category.POPULAR)
    }
